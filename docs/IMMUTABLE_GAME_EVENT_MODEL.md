...
`REDUCER_VERSION` is `4`. Version 2 added the schema-v3 runner-play transition
...
Version 4 validates substitution eligibility and defensive collisions, moves a
substituted runner without changing pitcher responsibility, and reconciles an
incoming pitcher's complete lineup and defensive assignment.
