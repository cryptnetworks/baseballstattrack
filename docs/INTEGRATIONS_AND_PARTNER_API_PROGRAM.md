...
| ------------------------------- | ----------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| Authenticated first-party user  | Supabase cookie or bearer session; current `AppUser`, membership, capability, and target are resolved | Web UI, statistics API, explicit export/admin routes           | Browser state is untrusted. Responses contain only the fields allowed by the requested operation and scope.                                      |
