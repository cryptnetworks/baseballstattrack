...
try {
  ...
  await client.query(`
    ...
    INSERT INTO "SourceEvent"
      ("id", "accountId", "gameId", "sequence", "eventType", "schemaVersion", "rulesetVersionId", "clientSubmissionId", "expectedRevision", "acceptedRevision", "payloadHash", "payload", "actorKind", "actorId", "recordedAt")
    VALUES
      ('fixture-event-start', 'fixture-account-a', 'fixture-game', 1, 'GameStarted', 1, 'fixture-ruleset', 'fixture-submit-1', 0, 1, 'fixture-hash-1', '{"inning": 1, "half": "top"}'::jsonb, 'SERVICE', 'fixture-scorekeeper-service', '2026-06-01T12:01:00Z'),
      ('fixture-event-substitution', 'fixture-account-a', 'fixture-game', 2, 'DefensiveSubstitutionMade', 1, 'fixture-ruleset', 'fixture-submit-2', 1, 2, 'fixture-hash-2', '{"outgoingPlayerId": "fixture-player-shared", "incomingPlayerId": "fixture-player-substitute"}'::jsonb, 'SERVICE', 'fixture-scorekeeper-service', '2026-06-01T12:02:00Z'),
      ('fixture-event-alignment', 'fixture-account-a', 'fixture-game', 3, 'DefensiveAlignmentChanged', 1, 'fixture-ruleset', 'fixture-submit-3', 2, 3, 'fixture-hash-3', '{"playerId": "fixture-player-substitute", "from": "SHORTSTOP", "to": "SECOND_BASE"}'::jsonb, 'SERVICE', 'fixture-scorekeeper-service', '2026-06-01T12:03:00Z'),
      ('fixture-event-pitching-1', 'fixture-account-a', 'fixture-game', 4, 'PitchingChangeMade', 1, 'fixture-ruleset', 'fixture-submit-4', 3, 4, 'fixture-hash-4', '{"outgoingPlayerId": "fixture-player-pitcher", "incomingPlayerId": "fixture-player-substitute", "inheritedRunners": []}'::jsonb, 'SERVICE', 'fixture-scorekeeper-service', '2026-06-01T12:04:00Z'),
      ('fixture-event-pitching-2', 'fixture-account-a', 'fixture-game', 5, 'PitchingChangeMade', 1, 'fixture-ruleset', 'fixture-submit-5', 4, 5, 'fixture-hash-5', '{"outgoingPlayerId": "fixture-player-substitute", "incomingPlayerId": "fixture-player-pitcher", "inheritedRunners": []}'::jsonb, 'SERVICE', 'fixture-scorekeeper-service', '2026-06-01T12:05:00Z'),
      ('fixture-event-extra-inning', 'fixture-account-a', 'fixture-game', 6, 'PlateAppearanceRecorded', 1, 'fixture-ruleset', 'fixture-submit-6', 5, 6, 'fixture-hash-6', '{"inning": 10, "half": "top", "outcome": "single"}'::jsonb, 'SERVICE', 'fixture-scorekeeper-service', '2026-06-01T12:06:00Z'),
      ('fixture-event-correction', 'fixture-account-a', 'fixture-game', 7, 'CorrectionApplied', 1, 'fixture-ruleset', 'fixture-submit-7', 6, 7, 'fixture-hash-7', '{"reasonCode": "SCORER_DECISION"}'::jsonb, 'SERVICE', 'fixture-scorekeeper-service', '2026-06-01T12:07:00Z'),
      ('fixture-event-replacement', 'fixture-account-a', 'fixture-game', 8, 'PlateAppearanceRecorded', 1, 'fixture-ruleset', 'fixture-submit-8', 7, 8, 'fixture-hash-8', '{"inning": 10, "half": "top", "outcome": "reached_on_error"}'::jsonb, 'SERVICE', 'fixture-scorekeeper-service', '2026-06-01T12:08:00Z');
