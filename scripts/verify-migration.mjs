...
const expectedConstraints = [
  ...
  "NotificationPreference_scope_check",
  "NotificationPreference_destination_check",
  ...
  "DiscordInstallation_identity_check",
  "DiscordInstallation_lifecycle_check",
  "DiscordChannelDestination_identity_check",
  "DiscordIntegrationSettings_values_check",
  "DiscordGuildRole_identity_check",
  "DiscordRoleGrant_values_check",
  "DiscordRoleGrant_lifecycle_check",
...
const expectedTriggers = [
  ...
  "NotificationDelivery_identity_immutable",
  "NotificationDeliveryAttempt_append_only",
  "DiscordInstallation_identity_immutable",
  "DiscordChannelDestination_identity_immutable",
  "DiscordIntegrationSettings_identity_immutable",
  "DiscordInstallation_enabled_settings_guard",
  "DiscordChannelDestination_enabled_settings_guard",
  "DiscordIntegrationSettings_enabled_guard",
  "DiscordSettingsScope_enabled_guard",
  "DiscordSettingsDestination_enabled_guard",
  "DiscordGuildRole_identity_immutable",
  "DiscordRoleGrant_identity_immutable",
  "DiscordInstallation_active_role_grant_guard",
  "DiscordGuildRole_active_grant_guard",
  "DiscordRoleGrant_active_guard",
